...
def format_final_output(input_dict):
    text_answer = input_dict["text_answer"]
    ...
    return {
        "answer": text_answer,
        "relevant_image": image_data, # <-- New key for the image
...
def ask():
    ...
    try:
        ...
        relevant_image = result.get('relevant_image')
        sources = []
        ...
        return jsonify({"answer": answer, "sources": sources, "relevant_image": relevant_image}) 
    except Exception as e:
